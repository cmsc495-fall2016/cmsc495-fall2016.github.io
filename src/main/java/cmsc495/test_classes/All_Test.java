...
/**
 * Brings together all 4 tables' test classes, allowing for creation & deletion based on what is commented out.
 *
 * @author Justin
...
public class All_Test {
    ...
    /**
     * Menu-driven test application. Offers the options to populate the database with our test information,
     * as well as clear out the tables (to leave the database clean).
