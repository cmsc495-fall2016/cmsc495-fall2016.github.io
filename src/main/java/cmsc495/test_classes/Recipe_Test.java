...
/**
 * Tests the Recipe entity as a standalone. Does not integrate Ingredient testing, also does not populate the 'uses'
    ...
    private void populateTestData(File file) throws IOException {
        ...
        try {
            ...
            while ((recipe = reader.readNext())!= null) {
                ...
                entry.name = recipe[1];
                entry.serves = Integer.parseInt(recipe[2].split(" ")[0]); // in case our Serves field has non-nummeric data.
